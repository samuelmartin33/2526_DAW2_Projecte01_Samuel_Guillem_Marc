...
// --- Lógica de la página ---
$id_sala_actual = 5; // <-- CAMBIO (Comedor 2 es ID 5)
$nombre_sala_actual = "Comedor 2"; // <-- CAMBIO
...
<head>
    ...
    <link rel="stylesheet" href="../../../css/comedor2.css"> <!-- <-- CAMBIO -->
</head>
<body>

    <div class="sala-container">

        <main class="sala-layout comedor2"> <!-- <-- CAMBIO -->
