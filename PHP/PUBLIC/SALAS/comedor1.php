...
// --- Lógica de la página ---
$id_sala_actual = 4; // <-- CAMBIO (Comedor 1 es ID 4)
$nombre_sala_actual = "Comedor 1"; // <-- CAMBIO
...
<head>
    ...
    <link rel="stylesheet" href="../../../css/comedor1.css"> <!-- <-- CAMBIO -->
</head>
<body>

    <div class="sala-container">

        <main class="sala-layout comedor1"> <!-- <-- CAMBIO -->
