...
// --- Lógica de la página ---
$id_sala_actual = 3; // <-- CAMBIO (Terraza 3 es ID 3)
$nombre_sala_actual = "Terraza 3"; // <-- CAMBIO
...
<head>
    ...
    <link rel="stylesheet" href="../../../css/terraza3.css"> <!-- <-- CAMBIO -->
</head>
<body>

    <div class="sala-container">

        <main class="sala-layout terraza3"> <!-- <-- CAMBIO -->
            ...
            <?php foreach ($mesas as $mesa): ?>
                ...
                >
                    <!-- La imagen de la mesa la coge de /img/mesa1.png (correcto) -->
