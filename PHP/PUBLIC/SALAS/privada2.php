...
// --- Lógica de la página ---
$id_sala_actual = 7; // <-- CAMBIO (Privada 2 es ID 7)
$nombre_sala_actual = "Privada 2"; // <-- CAMBIO
...
<head>
    ...
    <link rel="stylesheet" href="../../../css/privada2.css"> <!-- <-- CAMBIO -->
...
<body>
    ...
    <div class="sala-container">
        ...
        <main class="sala-layout privada2"> <!-- <-- CAMBIO -->
